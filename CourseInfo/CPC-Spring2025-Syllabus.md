...
**Limited formal instruction on statistics, data science, machine learning, and climate science will be given.** Project cycles run every 4 weeks, where we will have mini-group data projects. Groups will be formed randomly by the Professors with students from both climate science and data science backgrounds. Project products will be peer-reviewed, in addition to evaluation by the instructional team.
